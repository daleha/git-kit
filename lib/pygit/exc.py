...
""" Module containing all exceptions thrown througout the pygit package, """

from gitdb.exc import *

class InvalidGitPyRepositoryError(Exception):
...
class GitPyCommandError(Exception):
	""" Thrown if execution of the pygit command fails with non-zero status code. """
...
class CacheError(Exception):
	"""Base for all errors related to the pygit index, which is called cache internally"""
