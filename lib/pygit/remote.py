...
# Module implementing a remote object allowing easy access to pygit remotes
...
from pygit.util import  join_path
...
class FetchInfo(object):
	...
	Carries information about the results of a fetch operation of a single head::
	 ...
	 info.note			# additional notes given by pygit-fetch intended for the user
...
class Remote(LazyMixin, Iterable):
	"""Provides easy read and write access to a pygit remote.
	...
	def __getattr__(self, attr):
		...
		remote.special( *args, **kwargs) to call pygit-remote special self.name"""
	...
	def create(cls, repo, name, url, **kwargs):
		...
		:param kwargs:
			Additional arguments to be passed to the pygit-remote add command
	...
	def update(self, **kwargs):
		...
		:param kwargs:
			Additional arguments passed to pygit-remote update
	...
	def fetch(self, refspec=None, progress=None, **kwargs):
		...
		:param refspec:
			...
			For example: pygit fetch $URL refs/heads/master:refs/heads/origin means 
			"grab the master branch head from the $URL and store it as my origin 
			branch head". And pygit push $URL refs/heads/master:refs/heads/to-upstream 
			means "publish my master branch head as to-upstream branch at $URL". 
			See also pygit-push(1).
			
			Taken from the pygit manual
		:param progress: See 'push' method
		:param kwargs: Additional arguments to be passed to pygit-fetch
		:return:
	...
	def pull(self, refspec=None, progress=None, **kwargs):
		...
		:param progress: see 'push' method
		:param kwargs: Additional arguments to be passed to pygit-pull
	...
	def push(self, refspec=None, progress=None, **kwargs):
		...
		:param kwargs: Additional arguments to be passed to pygit-push
		:return:
