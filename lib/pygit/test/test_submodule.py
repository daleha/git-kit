...
from pygit.objects.submodule.base import Submodule
from pygit.objects.submodule.root import RootModule, RootUpdateProgress
from pygit.util import to_native_path_linux, join_path_native
import shutil
import pygit
import os
