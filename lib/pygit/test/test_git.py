...
from pygit import GitPy, GitCommandError
...
class TestGitPy(TestCase):
    ...
    def test_call_process_calls_execute(self, pygit):
        pygit.return_value = ''
        self.git.version()
    ...
    @patch_object(GitPy, 'execute')
    def test_it_ignores_false_kwargs(self, pygit):
        # this_should_not_be_ignored=False implies it *should* be ignored
        output = self.git.version(pass_this_kwarg=False)
        assert_true("pass_this_kwarg" not in pygit.call_args[1])
