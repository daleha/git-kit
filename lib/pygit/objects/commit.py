...
from pygit.diff import Diffable
...
class Commit(base.Object, Iterable, Diffable, Traversable, Serializable):
	"""Wraps a pygit Commit object.
	
	This class will act lazily on some of its attributes and will query the 
	value on demand only if it involves calling the pygit binary."""
	...
	def __init__(self, repo, binsha, tree=None, author=None, authored_date=None, author_tz_offset=None,
		...
		:note: Timezone information is in the same format and in the same sign 
			as what time.altzone returns. The sign is inverted compared to pygit's 
			UTC timezone."""
	...
	def count(self, paths='', **kwargs):
		...
		:param kwargs:
			Additional options to be passed to pygit-rev-list. They must not alter
	...
	def iter_items(cls, repo, rev, paths='', **kwargs):
		...
		:param kwargs:
			optional keyword arguments to pygit rev-list where
	...
	def iter_parents(self, paths='', **kwargs):
		...
		:param kwargs: All arguments allowed by pygit-rev-list
	...
	@property
	def stats(self):
		"""Create a pygit stat from changes between this commit and its first parent 
