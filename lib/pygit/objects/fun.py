...
def tree_to_stream(entries, write):
	...
	for binsha, mode, name in entries:
		...
		# pygit slices away the first octal if its zero
		if mode_str[0] == '0':
			mode_str = mode_str[1:]
		# END save a byte
		...
		# According to my tests, this is exactly what pygit does, that is it just
...
def tree_entries_from_data(data):
	...
	while i < len_data:
		...
		# read mode
		# Some pygit versions truncate the leading 0, some don't
		...
		# default encoding for strings in pygit is utf8
