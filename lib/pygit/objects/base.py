...
from pygit.util import LazyMixin, join_path_native, stream_copy
...
_assertion_msg_format = "Created object %r whose python type %r disagrees with the acutal pygit object type %r"
...
class Object(LazyMixin):
	...
	def __str__(self):
		""":return: string of our SHA1 as understood by all pygit commands"""
...
class IndexObject(Object):
	...
	def __init__(self, repo, binsha, mode=None, path=None):
		...
		:param path:
			is the path to the file in the file system, relative to the pygit repository root, i.e.
